        ...
        if (
            ...
            if (GAME_curFrame === 0) {
                ...
                Text.drawText(
                    "Click to start.",
                    325 -
                        Text.getTextWidth("Click to start.", "FontStuck", 1) /
                            2,
                    400,
                    "FontStuck",
                    hexToRgb("#000000"),
                ...
                ctxBuffer.drawImage(
                    sprErisolsprite,
                    442,
                    135 - GAME_erisolspriteArrowOffset,
                    44.775,
                    70.2
                );
                if (GAME_fade == 0)
                    ctxBuffer.drawImage(
                        sprArrow,
                        450,
                        113 + GAME_erisolspriteArrowOffset,
                        20.88,
                        12.96
                    );
                ...
                if (GAME_jasproseMessage == 1) {
                    ...
                    if (GAME_messageFrame > 0) {
                        Text.drawText(
                            "You interrogate the ghastly green sprite for answers.",
                            80,
                            50 - 6,
                            "FontStuck",
                            hexToRgb("#000000"),
                ...
                if (GAME_erisolspriteHeroPosX != 336) {
                    if (GAME_erisolspriteHeroPosX == 509.1) {
                        GAME_erisolspriteHeroPosX = 475.4;
                        GAME_erisolspriteHeroPosY = 90.4;
                    } else if (GAME_erisolspriteHeroPosX == 475.4) {
                        GAME_erisolspriteHeroPosX = 443.6;
                        GAME_erisolspriteHeroPosY = 70;
                    } else if (GAME_erisolspriteHeroPosX == 443.6) {
                        GAME_erisolspriteHeroPosX = 413.7;
                        GAME_erisolspriteHeroPosY = 51;
                    } else if (GAME_erisolspriteHeroPosX == 413.7) {
                        GAME_erisolspriteHeroPosX = 385.8;
                        GAME_erisolspriteHeroPosY = 33.1;
                    } else if (GAME_erisolspriteHeroPosX == 385.8) {
                        GAME_erisolspriteHeroPosX = 359.8;
                        GAME_erisolspriteHeroPosY = 16.4;
                    } else if (GAME_erisolspriteHeroPosX == 359.8) {
                        GAME_erisolspriteHeroPosX = 335.6;
                        GAME_erisolspriteHeroPosY = 1;
                    } else if (GAME_erisolspriteHeroPosX == 335.6) {
                        GAME_erisolspriteHeroPosX = 324.1;
                        GAME_erisolspriteHeroPosY = -6.3;
                        gifErisolpriteHero.start();
                    }

                    gifErisolpriteHero.setTransform(
                        GAME_erisolspriteHeroPosX,
                        GAME_erisolspriteHeroPosY,
                        442.96,
                        674.61
                    );
                }
                ...
                if (GAME_fuckButtonsPos != 33) {
                    ...
                    else if (GAME_fuckButtonsPos == -164)
                        GAME_fuckButtonsPos = -122;
                    else if (GAME_fuckButtonsPos == -122)
                        GAME_fuckButtonsPos = -82;
                    else if (GAME_fuckButtonsPos == -82)
                        GAME_fuckButtonsPos = -40;
                    else if (GAME_fuckButtonsPos == -40)
                        GAME_fuckButtonsPos = 0;
                    else if (GAME_fuckButtonsPos == 0) GAME_fuckButtonsPos = 42;
                    else if (GAME_fuckButtonsPos == 42)
                        GAME_fuckButtonsPos = 33;
                }
                ...
                if (GAME_fuckMessage) {
                    ...
                    if (GAME_messageFrame > 0) {
                        Text.drawText(
                            "fuck",
                            325 - Text.getTextWidth("fuck", "FontStuck", 1) / 2,
                            225 + 177 / 2 - 4,
                            "FontStuck",
                            hexToRgb("#4ac925"),
                            1
